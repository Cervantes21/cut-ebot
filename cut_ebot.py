...
loncheras = [list(mini_beauty), (lonchera_labastida), (lonchera_redonda)]
...
lonchera_labastida = [list(2 palas_ll, 1 f_arrastre_ll, 2 f_cierre_ll 2 cartera_ll, 2 tirantes_ll)]
palas_ll = 27.5 "x" 22
